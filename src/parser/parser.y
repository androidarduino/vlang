...
%token INT FLOAT CHAR VOID SHORT LONG DOUBLE UNSIGNED STRUCT UNION STATIC EXTERN TYPEDEF ENUM SIZEOF RETURN IF ELSE WHILE DO FOR SWITCH CASE DEFAULT BREAK CONTINUE ASM
